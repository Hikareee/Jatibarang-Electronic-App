...
import { MoreVertical, ChevronDown, ChevronUp, MessageCircle, Loader2, ClipboardList, Bell } from 'lucide-react'
...
function ExpenseRequestWorkflowPanel() {
    ...
    return (
      <div className="rounded-xl border border-teal-200 dark:border-teal-800 bg-teal-50/80 dark:bg-teal-900/20 px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-900 dark:text-white">Permintaan dana &amp; laporan biaya</p>
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
              Ajukan pembelian material atau biaya operasional dengan bukti invoice/tagihan. Admin menyetujui dari menu
              Biaya; Anda mendapat notifikasi saat disetujui atau ditolak.
            </p>
          </div>
        </div>
        <button
